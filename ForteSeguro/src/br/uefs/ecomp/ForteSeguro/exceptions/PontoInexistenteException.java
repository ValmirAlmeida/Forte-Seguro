...
/**
 * Exceção lançada ao tentar remover um ponto inexistente ou criar uma aresta que possui um ponto inexistente
...
public class PontoInexistenteException extends Exception {
    ...
    */
    public PontoInexistenteException() {
        super("O ponto informado não existe.");
    }
	...
	super("O ponto informado não existe.", causa);
    }
}
